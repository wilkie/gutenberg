...
function test_page() {
  $('#page-' + next_page).css('z-index', 2).css('height', 100);
}
...
function typeset(tag) {
  ...
  $('#cover .page-content').css('width', book_width).css('height', book_height);
  var last_page = $('#cover').css('width', book_width).css('height', book_height);
  ...
  function form_page() {
    ...
    $('<div id="page-' + pages_overall + '" class="page"><div class="page-content"></div></div>').insertAfter(last_page);

    last_page = $('#page-' + pages_overall).css('z-index', -pages_overall).css('width', book_width).css('height', book_height);
    var page = $('#page-' + pages_overall + ' .page-content').css('width', book_width).css('height', book_height);
